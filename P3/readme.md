...
**El prototipo HI-FI se puede encontrar en el siguiente** [enlace](https://www.figma.com/proto/To2q5EQfByXe9PWKtAC7HT/MoodBoard26?node-id=40000269-4351&t=8qDVssHn9hG30rfU-1&scaling=scale-down&content-scaling=fixed&page-id=40000269%3A3830)
...
| | |
|---|---|
| ![Personajes de Doraemon](imgs/inspiracion_doraemon_personajes.png) | ![Interior restaurante temático anime](imgs/inspiracion_restaurante_anime.png) |
| ![Dorayakis](imgs/inspiracion_dorayakis.png) | ![Robot camarero](imgs/inspiracion_robot_camarero.png) |
...
| | | |
|---|---|---|
| ![Local con robot camarero](imgs/foto_local_robot.png) | ![Familia comiendo](imgs/foto_familia_comiendo.png) | ![Platos de anime](imgs/foto_platos_anime.png) |
...
![Moodboard completo DorayakiYa](imgs/moodboard_completo.png)
...
![HI-FI Inicio con dropdown abierto](imgs/hifi_inicio_dropdown.png)
...
![Átomos: estilos de texto](imgs/atomos_estilos_texto.png)

![Átomos: elementos visuales](imgs/atomos_elementos.png)
...
![HI-FI: Inicio con dropdown](imgs/hifi_inicio_dropdown.png)

**Página de la Carta:**

![HI-FI: Carta](imgs/hifi_carta.png)

**Página de Reserva:**

Para la reserva se ha utilizado los recursos de reloj y calendario sacados de Figma.

![HI-FI: Reserva con calendario](imgs/hifi_reserva_calendario.png)

**Página de Reseñas:**

![HI-FI: Reseñas](imgs/hifi_resenas.png)

**Página del Carrito:**

![HI-FI: Carrito](imgs/hifi_carrito.png)
